...
public class Carpentry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview = findViewById(R.id.listviewCarpentry);
    ...
    private void viewData() {
        Cursor cursor = db.viewCarpentryRequests();

//        Toast.makeText(Pastrequests.this, "inside view data "+Long.toString(cursor.getCount()), Toast.LENGTH_SHORT).show();

        if (cursor.getCount()==0){
            Toast.makeText(Carpentry.this, "No data to show", Toast.LENGTH_SHORT).show();
        } else {
